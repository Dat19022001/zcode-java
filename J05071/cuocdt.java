...
public class cuocdt implements Comparable<cuocdt> {
    private String sdt;
    private ThanhPho tp;
    private Date start, end;

    public cuocdt(String sdt, ThanhPho tp, String start, String end) throws ParseException {
        this.sdt = sdt;
        this.tp = tp;
    ...
    @Override
    public int compareTo(cuocdt o) {
        return o.tongTien()>tongTien()?1:-1;
    }
}
